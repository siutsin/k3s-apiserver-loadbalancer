...
var (
	...
	projectImage = "example.com/k3s-apiserver-loadbalancer:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(ginkgo.GinkgoWriter, "Starting k3s-apiserver-loadbalancer integration test suite\n")
